...
DESCRIPTION="A Qt/C++ GUI front end to ecryptfs,cryfs,gocryptfs,securefs and encfs"
HOMEPAGE="github.com/mhogomchungu/sirikali"
SRC_URI="https://github.com/mhogomchungu/sirikali/releases/download/1.3.2/${P}.tar.xz"
